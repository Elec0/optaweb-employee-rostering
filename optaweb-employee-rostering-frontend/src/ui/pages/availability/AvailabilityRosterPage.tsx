...
export class AvailabilityRosterPage extends React.Component<Props, State> {
    ...
    render() {
        ...
        // The actual shift/availability data is stored here
        ...
        let empAvailList = this.props.employeeIdToAvailabilityListMap.get(shownEmployee.id as number);
        if (empAvailList !== undefined) {
            (empAvailList as EmployeeAvailability[])
                .forEach((ea) => {
                    events.push({
                        type: 'Availability',
        ...
        let empShiftList = this.props.employeeIdToShiftListMap.get(shownEmployee.id as number);
        if (empShiftList !== undefined) {
            (empShiftList as Shift[]).forEach((shift) => {
                events.push({
                    type: 'Shift',
        ...
        return (
            <>
                ...
                <Schedule<ShiftOrAvailability>
                    ...
                    // Trying to add using the original big-calendar buttons back into this
                    onNavigate={
                        (newDate, view, action) => {
                            this.onUpdateAvailabilityRoster({
                                ...urlProps,
